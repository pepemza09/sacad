...
export default function UserDropdown() {
  ...
  const circleColor = getColor(user?.email || user?.username || "User");
    ...
    <div className="relative">
      ...
      >
        {user?.foto ? (
          ...
          <span
            className={`mr-3 flex items-center justify-center rounded-full h-11 w-11 text-white text-sm font-semibold ${circleColor}`}
          >
            {initials}
          </span>
        )}
