...
const configCards = [
  ...
  {
    title: "Cargo / Dedicación / Carácter",
    description: "Permití configurar cargos, dedicaciones y el carácter que están disponibles para una designación docente.",
    icon: () => (
      <svg className="size-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  {
    title: "Nomenclador",
    description: "Configurá disciplinas, subdisciplinas y especialidades del nomenclador.",
    icon: () => (
      <svg className="size-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    href: "/configuracion/nomenclador",
  },
];
